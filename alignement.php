        ...
        <div id="grain-alignement">
            <div id="grain-alignement-etapes">
                <div class="grain-alignement-titre">
                    ...
                    <div class="grain-alignement-menu">
                        <a href="javascript:alignement.afficherInstruction()">
                ...
                <div class="grain-alignement-contenu" id="grain-alignement-listeEtapes">
                    <a href="javascript:alignement.changerEtape(1)">Tracer un chemin</a>
                    <a href="javascript:alignement.changerEtape(2)">Chercher un chemin optimal</a>
                    <a href="javascript:alignement.changerEtape(3)">Algorithme - phase 1</a>
                    <a href="javascript:alignement.changerEtape(4)">Retrouver les alignements optimaux</a>
                    <a href="javascript:alignement.changerEtape(5)">Algorithme - phase 2</a>
                </div>
            </div>
            <div id="grain-alignement-alignements">
                <div class="grain-alignement-titre">
                    Alignement Courant
                    <div class="grain-alignement-menu">
                        <a href="javascript:alignement.afficherMessage(1)">
                            <img src="alignement/aide.png" width="20" height="20" border="0" />
                        </a>
                    </div>
                </div>
            ...
            <div id="grain-alignement-optimal">
                <div class="grain-alignement-titre">
                    Coût optimal
                    <div class="grain-alignement-menu">
                        <a href="javascript:alignement.afficherMessage(2)">
                            <img src="alignement/aide.png" width="20" height="20" border="0" />
                        </a>
                    </div>
                </div>
...
if(is_numeric($_GET['etape'])) 
    $etape = $_GET['etape'];
if(isset($_GET['type'])) {
    $couts = $listeCouts[$_GET['matrice']];
    $coutGap = round($_GET["coutGap"],1);
    if($_GET["seq1"] != '')
        $seq1 = json_encode(str_split(strtoupper($_GET["seq1"])));
    if($_GET["seq2"] != '')
        $seq2 = json_encode(str_split(strtoupper($_GET["seq2"])));
    if($_GET['type'] == 1)
        $lettres = '["A", "R", "N", "D", "C", "Q", "E", "G", "H", "I", "L", "K", "M", "F", "P", "S", "T", "W", "Y", "V"]';
}
?>
        <script>
/*
...
$( function() {
    //Parametres
    /** Matrice coût */
    alignement.couts = <?php echo $couts ?>
    /** Coût d'un gap */
    alignement.coutGap = <?php echo $coutGap ?>
    /** Sequence 1 */
    alignement.x = <?php echo $seq1 ?>
    /** Sequence 2 */
    alignement.y = <?php echo $seq2 ?>
    /** Lettres */
    alignement.lettres = <?php echo $lettres ?>
    //Initialisation
    alignement.init()
    //chargement de l'étape
    alignement.changerEtape(<?php echo $etape ?>);
});
        </script>
        <!-- Fin du grain -->
        <!-- Début lancer -->
